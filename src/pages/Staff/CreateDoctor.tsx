...
export default function CreateDoctor() {
  ...
  async function handleSubmit(payload: CreateClinicStaffPayload | UpdateClinicStaffPayload) {
    ...
    try {
      ...
      navigate('/staff/doctors', { state: { successMsg: 'Doctor created successfully.' } });
    } catch (err) {
      setServerError(err instanceof Error ? err.message : 'Failed to create doctor.');
      setSaving(false);
    }
  }
  ...
  if (!canCreateStaff) {
    return (
      <div className={styles.accessDenied}>
        ...
        <p>Your current clinic role does not include permission to create staff members.</p>
      ...
      <div className={styles.page}>
        <div className={styles.pageHeader}>
          <div>
            ...
            <p className={styles.pageSubtitle}>Create a new doctor profile for your clinic.</p>
          </div>
          <Button
            variant="outline"
            icon="bi-arrow-left"
